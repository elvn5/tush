...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String email)?  submit,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Submit() when submit != null:
return submit(_that.email);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String email)  submit,}) {final _that = this;
switch (_that) {
case _Submit():
return submit(_that.email);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String email)?  submit,}) {final _that = this;
switch (_that) {
case _Submit() when submit != null:
return submit(_that.email);case _:
  return null;
...
class _Submit implements ForgotPasswordEvent {
  const _Submit({required this.email});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Submit&&(identical(other.email, email) || other.email == email));
}
...
@override
String toString() {
  return 'ForgotPasswordEvent.submit(email: $email)';
}
...
/// @nodoc
abstract mixin class _$SubmitCopyWith<$Res> implements $ForgotPasswordEventCopyWith<$Res> {
