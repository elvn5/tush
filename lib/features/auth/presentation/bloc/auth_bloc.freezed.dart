...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _CheckRequested value)?  checkRequested,TResult Function( _LoginSuccess value)?  loginSuccess,TResult Function( _LogoutRequested value)?  logoutRequested,required TResult orElse(),}){
final _that = this;
switch (_that) {
case _CheckRequested() when checkRequested != null:
return checkRequested(_that);case _LoginSuccess() when loginSuccess != null:
return loginSuccess(_that);case _LogoutRequested() when logoutRequested != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _CheckRequested value)  checkRequested,required TResult Function( _LoginSuccess value)  loginSuccess,required TResult Function( _LogoutRequested value)  logoutRequested,}){
final _that = this;
switch (_that) {
case _CheckRequested():
return checkRequested(_that);case _LoginSuccess():
return loginSuccess(_that);case _LogoutRequested():
return logoutRequested(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _CheckRequested value)?  checkRequested,TResult? Function( _LoginSuccess value)?  loginSuccess,TResult? Function( _LogoutRequested value)?  logoutRequested,}){
final _that = this;
switch (_that) {
case _CheckRequested() when checkRequested != null:
return checkRequested(_that);case _LoginSuccess() when loginSuccess != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  checkRequested,TResult Function()?  loginSuccess,TResult Function()?  logoutRequested,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CheckRequested() when checkRequested != null:
return checkRequested();case _LoginSuccess() when loginSuccess != null:
return loginSuccess();case _LogoutRequested() when logoutRequested != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  checkRequested,required TResult Function()  loginSuccess,required TResult Function()  logoutRequested,}) {final _that = this;
switch (_that) {
case _CheckRequested():
return checkRequested();case _LoginSuccess():
return loginSuccess();case _LogoutRequested():
return logoutRequested();case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  checkRequested,TResult? Function()?  loginSuccess,TResult? Function()?  logoutRequested,}) {final _that = this;
switch (_that) {
case _CheckRequested() when checkRequested != null:
return checkRequested();case _LoginSuccess() when loginSuccess != null:
return loginSuccess();case _LogoutRequested() when logoutRequested != null:
...
class _LoginSuccess implements AuthEvent {
  const _LoginSuccess();
