...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String email,  String code,  String newPassword)?  submit,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Submit() when submit != null:
return submit(_that.email,_that.code,_that.newPassword);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String email,  String code,  String newPassword)  submit,}) {final _that = this;
switch (_that) {
case _Submit():
return submit(_that.email,_that.code,_that.newPassword);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String email,  String code,  String newPassword)?  submit,}) {final _that = this;
switch (_that) {
case _Submit() when submit != null:
return submit(_that.email,_that.code,_that.newPassword);case _:
  return null;
...
class _Submit implements ResetPasswordEvent {
  const _Submit({required this.email, required this.code, required this.newPassword});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Submit&&(identical(other.email, email) || other.email == email)&&(identical(other.code, code) || other.code == code)&&(identical(other.newPassword, newPassword) || other.newPassword == newPassword));
}
...
@override
String toString() {
  return 'ResetPasswordEvent.submit(email: $email, code: $code, newPassword: $newPassword)';
}
...
/// @nodoc
abstract mixin class _$SubmitCopyWith<$Res> implements $ResetPasswordEventCopyWith<$Res> {
