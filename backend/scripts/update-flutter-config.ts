...
// Update lib/amplifyconfiguration.dart
const amplifyConfigPath = path.join(
  __dirname,
  "../../lib/amplifyconfiguration.dart"
);

const amplifyConfigContent = `const amplifyconfig = '''{
...
fs.writeFileSync(amplifyConfigPath, amplifyConfigContent, "utf8");
console.log("✅ Successfully updated lib/amplifyconfiguration.dart");
