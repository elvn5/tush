...
function* serializingStructIterator(ns, sourceObject) {
  ...
  for (let i6 = 0; i6 < struct[4].length; ++i6) {
    ...
    const memberNs = new NormalizedSchema([struct[5][i6], 0], key);
  ...
  if (customHeaders) {
    if (!(customHeaders instanceof Headers)) {
      try {
        ...
        throw new GoogleGenerativeAIRequestInputError(`unable to convert customHeaders value ${JSON.stringify(customHeaders)} to Headers: ${e6.message}`);
      }
    }
...
function handleResponseError(e6, url) {
  let err2 = e6;
  if (err2.name === "AbortError") {
    err2 = new GoogleGenerativeAIAbortError(`Request aborted when fetching ${url.toString()}: ${e6.message}`);
    err2.stack = e6.stack;
  } else if (!(e6 instanceof GoogleGenerativeAIFetchError || e6 instanceof GoogleGenerativeAIRequestInputError)) {
    err2 = new GoogleGenerativeAIError(`Error fetching from ${url.toString()}: ${e6.message}`);
    err2.stack = e6.stack;
  }
  throw err2;
}
...
function getText(response) {
  ...
  if ((_b = (_a2 = response.candidates) === null || _a2 === void 0 ? void 0 : _a2[0].content) === null || _b === void 0 ? void 0 : _b.parts) {
    for (const part of (_d = (_c6 = response.candidates) === null || _c6 === void 0 ? void 0 : _c6[0].content) === null || _d === void 0 ? void 0 : _d.parts) {
      if (part.text) {
...
function formatBlockErrorMessage(response) {
  ...
  } else if ((_c6 = response.candidates) === null || _c6 === void 0 ? void 0 : _c6[0]) {
...
function __asyncGenerator(thisArg, _arguments, generator) {
  ...
  function settle(f6, v7) {
    if (f6(v7), q6.shift(), q6.length) resume(q6[0][0], q6[0][1]);
  }
...
var ChatSession = class {
  ...
  async sendMessage(request2, requestOptions = {}) {
    ...
    const generateContentRequest = {
      ...
      tools: (_c6 = this.params) === null || _c6 === void 0 ? void 0 : _c6.tools,
      toolConfig: (_d = this.params) === null || _d === void 0 ? void 0 : _d.toolConfig,
      systemInstruction: (_e6 = this.params) === null || _e6 === void 0 ? void 0 : _e6.systemInstruction,
...
var handler = /* @__PURE__ */ __name(async (event) => {
  ...
  for (const record of event.Records) {
    try {
      ...
      const prompt = `\xAB\u0414\u0435\u0439\u0441\u0442\u0432\u0443\u0439 \u043A\u0430\u043A \u043F\u0440\u043E\u0444\u0435\u0441\u0441\u0438\u043E\u043D\u0430\u043B\u044C\u043D\u044B\u0439 \u043F\u0441\u0438\u0445\u043E\u043B\u043E\u0433 \u0438 \u0430\u043D\u0430\u043B\u0438\u0442\u0438\u043A \u0441\u043D\u043E\u0432\u0438\u0434\u0435\u043D\u0438\u0439 (\u0438\u0441\u043F\u043E\u043B\u044C\u0437\u0443\u044F \u043F\u043E\u0434\u0445\u043E\u0434 \u042E\u043D\u0433\u0430 \u0438 \u0441\u043E\u0432\u0440\u0435\u043C\u0435\u043D\u043D\u044B\u0435 \u043A\u043E\u0433\u043D\u0438\u0442\u0438\u0432\u043D\u044B\u0435 \u043C\u0435\u0442\u043E\u0434\u0438\u043A\u0438).
...
\u041C\u043E\u0439 \u0441\u043E\u043D:`;
      ...
      const updateParams = {
        ...
        UpdateExpression: "SET interpretation = :i, isReady = :r, updatedAt = :u",
