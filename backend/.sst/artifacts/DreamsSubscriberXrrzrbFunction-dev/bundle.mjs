...
var init_schemaDeserializationMiddleware = __esm({
  "node_modules/@smithy/core/dist-es/submodules/schema/middleware/schemaDeserializationMiddleware.js"() {
    ...
    schemaDeserializationMiddleware = /* @__PURE__ */ __name((config) => (next, context) => async (args) => {
      ...
      const [, ns, n7, t7, i7, o7] = operationSchema ?? [];
      try {
        const parsed = await config.protocol.deserializeResponse(operation(ns, n7, t7, i7, o7), {
          ...config,
          ...context
        }, response);
        return {
...
var init_schemaSerializationMiddleware = __esm({
  "node_modules/@smithy/core/dist-es/submodules/schema/middleware/schemaSerializationMiddleware.js"() {
    ...
    schemaSerializationMiddleware = /* @__PURE__ */ __name((config) => (next, context) => async (args) => {
      ...
      const request2 = await config.protocol.serializeRequest(operation(ns, n7, t7, i7, o7), args.input, {
        ...config,
        ...context,
        endpoint
      });
...
function* serializingStructIterator(ns, sourceObject) {
  ...
  for (let i7 = 0; i7 < struct[4].length; ++i7) {
    ...
    const memberNs = new NormalizedSchema([struct[5][i7], 0], key);
...
var _ADE, _APE, _AT, _CS, _CT, _CTR, _CTRr, _CV, _ETE, _ICE2, _IGE, _IRE, _ISE2, _ISEn, _IT, _RT, _SDE, _UCE, _UGTE, _aT, _c2, _cI, _cS, _cV, _co, _dC, _e2, _eI, _ed, _gT, _h, _hE2, _iT, _r2, _rT, _rU, _s2, _se, _sm2, _tT, n02, AccessToken, ClientSecret, CodeVerifier, IdToken, RefreshToken, AccessDeniedException2, AuthorizationPendingException2, CreateTokenRequest, CreateTokenResponse, ExpiredTokenException2, InternalServerException2, InvalidClientException2, InvalidGrantException2, InvalidRequestException2, InvalidScopeException2, SlowDownException2, UnauthorizedClientException2, UnsupportedGrantTypeException2, SSOOIDCServiceException2, Scopes, CreateToken;
var init_schemas_0 = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso-oidc/schemas/schemas_0.js"() {
    ...
    TypeRegistry.for(n02).registerError(AccessDeniedException2, AccessDeniedException);
    AuthorizationPendingException2 = [
      -3,
      n02,
      _APE,
      {
    ...
    TypeRegistry.for(n02).registerError(AuthorizationPendingException2, AuthorizationPendingException);
    CreateTokenRequest = [
      3,
      n02,
      _CTR,
    ...
    TypeRegistry.for(n02).registerError(ExpiredTokenException2, ExpiredTokenException);
    ...
    TypeRegistry.for(n02).registerError(InternalServerException2, InternalServerException);
    ...
    TypeRegistry.for(n02).registerError(InvalidClientException2, InvalidClientException);
    ...
    TypeRegistry.for(n02).registerError(InvalidGrantException2, InvalidGrantException);
    ...
    TypeRegistry.for(n02).registerError(InvalidRequestException2, InvalidRequestException);
    ...
    TypeRegistry.for(n02).registerError(InvalidScopeException2, InvalidScopeException);
    SlowDownException2 = [
      -3,
      n02,
      _SDE,
    ...
    TypeRegistry.for(n02).registerError(SlowDownException2, SlowDownException);
    ...
    TypeRegistry.for(n02).registerError(UnauthorizedClientException2, UnauthorizedClientException);
    ...
    TypeRegistry.for(n02).registerError(UnsupportedGrantTypeException2, UnsupportedGrantTypeException);
    SSOOIDCServiceException2 = [-3, _sm2, "SSOOIDCServiceException", 0, [], []];
    TypeRegistry.for(_sm2).registerError(SSOOIDCServiceException2, SSOOIDCServiceException);
    Scopes = 64 | 0;
    CreateToken = [
      9,
      n02,
...
var init_CreateTokenCommand = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso-oidc/commands/CreateTokenCommand.js"() {
    ...
    init_EndpointParameters();
    init_schemas_0();
    CreateTokenCommand = class extends Command.classBuilder().ep(commonParams2).m(function(Command2, cs, config, o7) {
...
var init_getSsoOidcClient = __esm({
  "node_modules/@aws-sdk/token-providers/dist-es/getSsoOidcClient.js"() {
    getSsoOidcClient = /* @__PURE__ */ __name(async (ssoRegion, init = {}) => {
      ...
      const coalesce = /* @__PURE__ */ __name((prop) => init.clientConfig?.[prop] ?? init.parentClientConfig?.[prop], "coalesce");
...
var InvalidRequestException3, ResourceNotFoundException3, TooManyRequestsException, UnauthorizedException;
var init_errors2 = __esm({
  "node_modules/@aws-sdk/client-sso/dist-es/models/errors.js"() {
    init_SSOServiceException();
    InvalidRequestException3 = class _InvalidRequestException extends SSOServiceException {
      static {
        __name(this, "InvalidRequestException");
      }
      name = "InvalidRequestException";
    ...
    ResourceNotFoundException3 = class _ResourceNotFoundException extends SSOServiceException {
      static {
...
var _AI, _ALT, _ATT, _GRC, _GRCR, _GRCRe, _IRE2, _L2, _LA, _LAR, _LARR, _LARRi, _LARi, _LARis, _LR, _RC, _RI, _RLT, _RNFE2, _SAKT, _STT, _TMRE, _UE2, _aI, _aKI, _aL, _aN, _aT2, _ai, _c3, _e3, _eA, _ex, _h2, _hE3, _hH2, _hQ, _m2, _mR, _mr, _nT, _nt, _rC, _rL, _rN, _rn, _s3, _sAK, _sT, _xasbt, n03, AccessTokenType, SecretAccessKeyType, SessionTokenType, AccountInfo, GetRoleCredentialsRequest, GetRoleCredentialsResponse, InvalidRequestException4, ListAccountRolesRequest, ListAccountRolesResponse, ListAccountsRequest, ListAccountsResponse, LogoutRequest, ResourceNotFoundException4, RoleCredentials, RoleInfo, TooManyRequestsException2, UnauthorizedException2, __Unit, SSOServiceException2, AccountListType, RoleListType, GetRoleCredentials, ListAccountRoles, ListAccounts, Logout;
var init_schemas_02 = __esm({
  "node_modules/@aws-sdk/client-sso/dist-es/schemas/schemas_0.js"() {
    ...
    AccountInfo = [3, n03, _AI, 0, [_aI, _aN, _eA], [0, 0, 0]];
    ...
    GetRoleCredentialsResponse = [3, n03, _GRCRe, 0, [_rC], [[() => RoleCredentials, 0]]];
    InvalidRequestException4 = [
      -3,
      n03,
      _IRE2,
      {
    ...
    TypeRegistry.for(n03).registerError(InvalidRequestException4, InvalidRequestException3);
    ...
    ListAccountRolesResponse = [3, n03, _LARRi, 0, [_nT, _rL], [0, () => RoleListType]];
    ListAccountsRequest = [
      3,
      n03,
      _LAR,
    ...
    ListAccountsResponse = [3, n03, _LARi, 0, [_nT, _aL], [0, () => AccountListType]];
    LogoutRequest = [
      3,
      n03,
      _LR,
    ...
    TypeRegistry.for(n03).registerError(ResourceNotFoundException4, ResourceNotFoundException3);
    RoleCredentials = [
      3,
      n03,
      _RC,
    ...
    RoleInfo = [3, n03, _RI, 0, [_rN, _aI], [0, 0]];
    ...
    TypeRegistry.for(n03).registerError(TooManyRequestsException2, TooManyRequestsException);
    ...
    TypeRegistry.for(n03).registerError(UnauthorizedException2, UnauthorizedException);
    __Unit = "unit";
    SSOServiceException2 = [-3, _s3, "SSOServiceException", 0, [], []];
    TypeRegistry.for(_s3).registerError(SSOServiceException2, SSOServiceException);
    AccountListType = [1, n03, _ALT, 0, () => AccountInfo];
    RoleListType = [1, n03, _RLT, 0, () => RoleInfo];
    GetRoleCredentials = [
      9,
      n03,
      _GRC,
...
var init_GetRoleCredentialsCommand = __esm({
  "node_modules/@aws-sdk/client-sso/dist-es/commands/GetRoleCredentialsCommand.js"() {
    ...
    init_EndpointParameters2();
    init_schemas_02();
    GetRoleCredentialsCommand = class extends Command.classBuilder().ep(commonParams3).m(function(Command2, cs, config, o7) {
      return [getEndpointPlugin(config, Command2.getEndpointParameterInstructions())];
...
var init_ListAccountRolesCommand = __esm({
  "node_modules/@aws-sdk/client-sso/dist-es/commands/ListAccountRolesCommand.js"() {
    ...
    init_EndpointParameters2();
    init_schemas_02();
    ListAccountRolesCommand = class extends Command.classBuilder().ep(commonParams3).m(function(Command2, cs, config, o7) {
      return [getEndpointPlugin(config, Command2.getEndpointParameterInstructions())];
...
var init_ListAccountsCommand = __esm({
  "node_modules/@aws-sdk/client-sso/dist-es/commands/ListAccountsCommand.js"() {
    ...
    init_EndpointParameters2();
    init_schemas_02();
    ListAccountsCommand = class extends Command.classBuilder().ep(commonParams3).m(function(Command2, cs, config, o7) {
      return [getEndpointPlugin(config, Command2.getEndpointParameterInstructions())];
...
var init_LogoutCommand = __esm({
  "node_modules/@aws-sdk/client-sso/dist-es/commands/LogoutCommand.js"() {
    ...
    init_EndpointParameters2();
    init_schemas_02();
    LogoutCommand = class extends Command.classBuilder().ep(commonParams3).m(function(Command2, cs, config, o7) {
      return [getEndpointPlugin(config, Command2.getEndpointParameterInstructions())];
...
var init_resolveSSOCredentials = __esm({
  "node_modules/@aws-sdk/credential-provider-sso/dist-es/resolveSSOCredentials.js"() {
    ...
    resolveSSOCredentials = /* @__PURE__ */ __name(async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, profile, filepath, configFilepath, ignoreCache, logger: logger2 }) => {
      let token;
  ...
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/sts/schemas/schemas_0.js"() {
    ...
    ExpiredTokenException4 = [
      ...
      _ETE2,
      {
        [_e4]: _c4,
        [_hE4]: 400,
        [_aQE2]: [`ExpiredTokenException`, 400]
      },
      [_m3],
      [0]
    ];
    TypeRegistry.for(n04).registerError(ExpiredTokenException4, ExpiredTokenException3);
    IDPCommunicationErrorException2 = [
      ...
      _IDPCEE,
      {
        [_e4]: _c4,
        [_hE4]: 400,
        [_aQE2]: [`IDPCommunicationError`, 400]
      },
      [_m3],
      [0]
    ];
    TypeRegistry.for(n04).registerError(IDPCommunicationErrorException2, IDPCommunicationErrorException);
    IDPRejectedClaimException2 = [
      -3,
      n04,
      _IDPRCE,
      {
        [_e4]: _c4,
        [_hE4]: 403,
        [_aQE2]: [`IDPRejectedClaim`, 403]
      },
      [_m3],
      [0]
    ];
    TypeRegistry.for(n04).registerError(IDPRejectedClaimException2, IDPRejectedClaimException);
    InvalidIdentityTokenException2 = [
      -3,
      n04,
      _IITE,
      {
        [_e4]: _c4,
        [_hE4]: 400,
        [_aQE2]: [`InvalidIdentityToken`, 400]
      },
      [_m3],
      [0]
    ];
    TypeRegistry.for(n04).registerError(InvalidIdentityTokenException2, InvalidIdentityTokenException);
    MalformedPolicyDocumentException2 = [
      -3,
      n04,
      _MPDE,
      {
        [_e4]: _c4,
        [_hE4]: 400,
        [_aQE2]: [`MalformedPolicyDocument`, 400]
      },
      [_m3],
      [0]
    ];
    TypeRegistry.for(n04).registerError(MalformedPolicyDocumentException2, MalformedPolicyDocumentException);
    PackedPolicyTooLargeException2 = [
      -3,
      n04,
      _PPTLE,
      {
        [_e4]: _c4,
        [_hE4]: 400,
        [_aQE2]: [`PackedPolicyTooLarge`, 400]
      },
      [_m3],
      [0]
    ];
    TypeRegistry.for(n04).registerError(PackedPolicyTooLargeException2, PackedPolicyTooLargeException);
    PolicyDescriptorType = [3, n04, _PDT, 0, [_a], [0]];
    ProvidedContext = [3, n04, _PCr, 0, [_PAr, _CA], [0, 0]];
    RegionDisabledException2 = [
      -3,
      n04,
      _RDE,
      {
        [_e4]: _c4,
        [_hE4]: 403,
        [_aQE2]: [`RegionDisabledException`, 403]
      },
      [_m3],
      [0]
    ];
    TypeRegistry.for(n04).registerError(RegionDisabledException2, RegionDisabledException);
    Tag = [3, n04, _Ta, 0, [_K2, _V2], [0, 0]];
    STSServiceException2 = [-3, _s4, "STSServiceException", 0, [], []];
    TypeRegistry.for(_s4).registerError(STSServiceException2, STSServiceException);
...
var init_AssumeRoleCommand = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/sts/commands/AssumeRoleCommand.js"() {
    ...
    init_EndpointParameters3();
    init_schemas_03();
    AssumeRoleCommand = class extends Command.classBuilder().ep(commonParams4).m(function(Command2, cs, config, o7) {
      return [getEndpointPlugin(config, Command2.getEndpointParameterInstructions())];
...
var init_AssumeRoleWithWebIdentityCommand = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/sts/commands/AssumeRoleWithWebIdentityCommand.js"() {
    ...
    init_EndpointParameters3();
    init_schemas_03();
    AssumeRoleWithWebIdentityCommand = class extends Command.classBuilder().ep(commonParams4).m(function(Command2, cs, config, o7) {
      return [getEndpointPlugin(config, Command2.getEndpointParameterInstructions())];
...
var init_resolveAssumeRoleCredentials = __esm({
  "node_modules/@aws-sdk/credential-provider-ini/dist-es/resolveAssumeRoleCredentials.js"() {
    ...
    resolveAssumeRoleCredentials = /* @__PURE__ */ __name(async (profileName, profiles, options, visitedProfiles = {}, resolveProfileData2) => {
...
var init_errors4 = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/signin/models/errors.js"() {
    ...
    InternalServerException3 = class _InternalServerException extends SigninServiceException {
      static {
        __name(this, "InternalServerException");
      }
      name = "InternalServerException";
...
var _ADE2, _AT2, _COAT, _COATR, _COATRB, _COATRBr, _COATRr, _ISE3, _RT2, _TMRE2, _VE, _aKI2, _aT3, _c5, _cI2, _cV2, _co2, _e5, _eI2, _gT2, _h3, _hE5, _iT2, _jN, _m4, _rT2, _rU2, _s5, _sAK2, _sT2, _sm3, _tI, _tO, _tT2, n05, RefreshToken2, AccessDeniedException4, AccessToken2, CreateOAuth2TokenRequest, CreateOAuth2TokenRequestBody, CreateOAuth2TokenResponse, CreateOAuth2TokenResponseBody, InternalServerException4, TooManyRequestsError2, ValidationException2, SigninServiceException2, CreateOAuth2Token;
var init_schemas_04 = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/signin/schemas/schemas_0.js"() {
    ...
    TypeRegistry.for(n05).registerError(AccessDeniedException4, AccessDeniedException3);
    AccessToken2 = [
      3,
      n05,
      _AT2,
    ...
    TypeRegistry.for(n05).registerError(InternalServerException4, InternalServerException3);
    ...
    TypeRegistry.for(n05).registerError(TooManyRequestsError2, TooManyRequestsError);
    ...
    TypeRegistry.for(n05).registerError(ValidationException2, ValidationException);
    SigninServiceException2 = [-3, _sm3, "SigninServiceException", 0, [], []];
    TypeRegistry.for(_sm3).registerError(SigninServiceException2, SigninServiceException);
    CreateOAuth2Token = [
      9,
      n05,
      _COAT,
...
var init_CreateOAuth2TokenCommand = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/signin/commands/CreateOAuth2TokenCommand.js"() {
    ...
    init_EndpointParameters4();
    init_schemas_04();
    CreateOAuth2TokenCommand = class extends Command.classBuilder().ep(commonParams5).m(function(Command2, cs, config, o7) {
      return [getEndpointPlugin(config, Command2.getEndpointParameterInstructions())];
...
var init_resolveLoginCredentials = __esm({
  "node_modules/@aws-sdk/credential-provider-ini/dist-es/resolveLoginCredentials.js"() {
    ...
    resolveLoginCredentials = /* @__PURE__ */ __name(async (profileName, options) => {
...
var init_resolveWebIdentityCredentials = __esm({
  "node_modules/@aws-sdk/credential-provider-ini/dist-es/resolveWebIdentityCredentials.js"() {
    ...
    resolveWebIdentityCredentials = /* @__PURE__ */ __name(async (profile, options) => Promise.resolve().then(() => (init_dist_es53(), dist_es_exports6)).then(({ fromTokenFile: fromTokenFile2 }) => fromTokenFile2({
...
TypeRegistry.for(n0).registerError(BackupInUseException2, BackupInUseException);
var BackupNotFoundException2 = [
  -3,
  n0,
  _BNFE,
  {
...
TypeRegistry.for(n0).registerError(BackupNotFoundException2, BackupNotFoundException);
...
var ConditionalCheckFailedException2 = [
  -3,
  n0,
  _CCFE,
  {
...
TypeRegistry.for(n0).registerError(ConditionalCheckFailedException2, ConditionalCheckFailedException);
var ConditionCheck = [
  3,
  n0,
  _CCo,
...
var ContinuousBackupsUnavailableException2 = [
  -3,
  n0,
  _CBUE,
  {
...
TypeRegistry.for(n0).registerError(ContinuousBackupsUnavailableException2, ContinuousBackupsUnavailableException);
...
TypeRegistry.for(n0).registerError(DuplicateItemException2, DuplicateItemException);
...
TypeRegistry.for(n0).registerError(ExportConflictException2, ExportConflictException);
var ExportNotFoundException2 = [
  -3,
  n0,
  _ENFE,
  {
...
TypeRegistry.for(n0).registerError(ExportNotFoundException2, ExportNotFoundException);
...
var GlobalTableAlreadyExistsException2 = [
  -3,
  n0,
  _GTAEE,
  {
...
TypeRegistry.for(n0).registerError(GlobalTableAlreadyExistsException2, GlobalTableAlreadyExistsException);
var GlobalTableNotFoundException2 = [
  -3,
  n0,
  _GTNFE,
  {
...
TypeRegistry.for(n0).registerError(GlobalTableNotFoundException2, GlobalTableNotFoundException);
...
TypeRegistry.for(n0).registerError(IdempotentParameterMismatchException2, IdempotentParameterMismatchException);
var ImportConflictException2 = [
  -3,
  n0,
  _ICE,
  {
...
TypeRegistry.for(n0).registerError(ImportConflictException2, ImportConflictException);
var ImportNotFoundException2 = [
  -3,
  n0,
  _INFE,
  {
...
TypeRegistry.for(n0).registerError(ImportNotFoundException2, ImportNotFoundException);
var IndexNotFoundException2 = [
  -3,
  n0,
  _INFEn,
  {
...
TypeRegistry.for(n0).registerError(IndexNotFoundException2, IndexNotFoundException);
...
TypeRegistry.for(n0).registerError(InternalServerError2, InternalServerError);
var InvalidEndpointException2 = [
  -3,
  n0,
  _IEE,
  {
...
TypeRegistry.for(n0).registerError(InvalidEndpointException2, InvalidEndpointException);
var InvalidExportTimeException2 = [
  -3,
  n0,
  _IETE,
  {
...
TypeRegistry.for(n0).registerError(InvalidExportTimeException2, InvalidExportTimeException);
var InvalidRestoreTimeException2 = [
  -3,
  n0,
  _IRTE,
  {
...
TypeRegistry.for(n0).registerError(InvalidRestoreTimeException2, InvalidRestoreTimeException);
...
var ItemCollectionSizeLimitExceededException2 = [
  -3,
  n0,
  _ICSLEE,
  {
...
TypeRegistry.for(n0).registerError(ItemCollectionSizeLimitExceededException2, ItemCollectionSizeLimitExceededException);
...
TypeRegistry.for(n0).registerError(LimitExceededException2, LimitExceededException);
var ListTablesOutput = [3, n0, _LTO, 0, [_TNa, _LETN], [64 | 0, 0]];
var PointInTimeRecoveryUnavailableException2 = [
  -3,
  n0,
  _PITRUE,
  {
...
TypeRegistry.for(n0).registerError(PointInTimeRecoveryUnavailableException2, PointInTimeRecoveryUnavailableException);
var PolicyNotFoundException2 = [
  -3,
  n0,
  _PNFE,
  {
...
TypeRegistry.for(n0).registerError(PolicyNotFoundException2, PolicyNotFoundException);
...
TypeRegistry.for(n0).registerError(ProvisionedThroughputExceededException2, ProvisionedThroughputExceededException);
var Put = [
  3,
  n0,
  _Pu,
...
var ReplicaAlreadyExistsException2 = [
  -3,
  n0,
  _RAEE,
  {
...
TypeRegistry.for(n0).registerError(ReplicaAlreadyExistsException2, ReplicaAlreadyExistsException);
var ReplicaNotFoundException2 = [
  -3,
  n0,
  _RNFE,
  {
...
TypeRegistry.for(n0).registerError(ReplicaNotFoundException2, ReplicaNotFoundException);
var ReplicatedWriteConflictException2 = [
  -3,
  n0,
  _RWCE,
  {
...
TypeRegistry.for(n0).registerError(ReplicatedWriteConflictException2, ReplicatedWriteConflictException);
var RequestLimitExceeded2 = [
  -3,
  n0,
  _RLE,
  {
...
TypeRegistry.for(n0).registerError(RequestLimitExceeded2, RequestLimitExceeded);
...
var TableAlreadyExistsException2 = [
  -3,
  n0,
  _TAEE,
  {
...
TypeRegistry.for(n0).registerError(TableAlreadyExistsException2, TableAlreadyExistsException);
var TableInUseException2 = [
  -3,
  n0,
  _TIUE,
  {
...
TypeRegistry.for(n0).registerError(TableInUseException2, TableInUseException);
var TableNotFoundException2 = [
  -3,
  n0,
  _TNFE,
  {
...
TypeRegistry.for(n0).registerError(TableNotFoundException2, TableNotFoundException);
...
TypeRegistry.for(n0).registerError(ThrottlingException2, ThrottlingException);
var ThrottlingReason = [3, n0, _TRh, 0, [_r, _re], [0, 0]];
var TransactionCanceledException2 = [
  -3,
  n0,
  _TCE,
  {
...
TypeRegistry.for(n0).registerError(TransactionCanceledException2, TransactionCanceledException);
var TransactionConflictException2 = [
  -3,
  n0,
  _TCEr,
  {
...
TypeRegistry.for(n0).registerError(TransactionConflictException2, TransactionConflictException);
var TransactionInProgressException2 = [
  -3,
  n0,
  _TIPE,
  {
...
TypeRegistry.for(n0).registerError(TransactionInProgressException2, TransactionInProgressException);
...
var DynamoDBServiceException2 = [-3, _sm, "DynamoDBServiceException", 0, [], []];
TypeRegistry.for(_sm).registerError(DynamoDBServiceException2, DynamoDBServiceException);
...
// node_modules/@aws-sdk/client-dynamodb/dist-es/commands/DescribeEndpointsCommand.js
var DescribeEndpointsCommand = class extends Command.classBuilder().ep(commonParams).m(function(Command2, cs, config, o7) {
  return [getEndpointPlugin(config, Command2.getEndpointParameterInstructions())];
...
var getRuntimeConfig9 = /* @__PURE__ */ __name((config) => {
  return {
    ...
    logger: config?.logger ?? new NoOpLogger(),
    protocol: config?.protocol ?? new AwsJson1_0Protocol({
...
}).m(function(Command2, cs, config, o7) {
  return [getEndpointPlugin(config, Command2.getEndpointParameterInstructions())];
...
// node_modules/@aws-sdk/client-apigatewaymanagementapi/dist-es/auth/httpAuthSchemeProvider.js
init_dist_es29();
init_dist_es2();
var defaultApiGatewayManagementApiHttpAuthSchemeParametersProvider = /* @__PURE__ */ __name(async (config, context, input) => {
  return {
    operation: getSmithyContext(context).operation,
    region: await normalizeProvider(config.region)() || (() => {
      throw new Error("expected `region` to be configured for `aws.auth#sigv4`");
...
}, "defaultApiGatewayManagementApiHttpAuthSchemeParametersProvider");
...
var defaultApiGatewayManagementApiHttpAuthSchemeProvider = /* @__PURE__ */ __name((authParameters) => {
  const options = [];
  switch (authParameters.operation) {
    default: {
  ...
  return options;
}, "defaultApiGatewayManagementApiHttpAuthSchemeProvider");
...
var a6 = true;
var b6 = "isSet";
var c6 = "booleanEquals";
var d6 = "error";
var e6 = "endpoint";
var f6 = "tree";
var g6 = "PartitionResult";
var h6 = { [s6]: false, "type": "string" };
var i6 = { [s6]: true, "default": false, "type": "boolean" };
var j6 = { [v7]: "Endpoint" };
var k6 = { [t6]: c6, [u6]: [{ [v7]: "UseFIPS" }, true] };
var l6 = { [t6]: c6, [u6]: [{ [v7]: "UseDualStack" }, true] };
var m6 = {};
var n6 = { [t6]: "getAttr", [u6]: [{ [v7]: g6 }, "supportsFIPS"] };
var o6 = { [t6]: c6, [u6]: [true, { [t6]: "getAttr", [u6]: [{ [v7]: g6 }, "supportsDualStack"] }] };
var p6 = [k6];
var q6 = [l6];
var r6 = [{ [v7]: "Region" }];
var _data6 = { version: "1.0", parameters: { Region: h6, UseDualStack: i6, UseFIPS: i6, Endpoint: h6 }, rules: [{ conditions: [{ [t6]: b6, [u6]: [j6] }], rules: [{ conditions: p6, error: "Invalid Configuration: FIPS and custom endpoint are not supported", type: d6 }, { conditions: q6, error: "Invalid Configuration: Dualstack and custom endpoint are not supported", type: d6 }, { endpoint: { url: j6, properties: m6, headers: m6 }, type: e6 }], type: f6 }, { conditions: [{ [t6]: b6, [u6]: r6 }], rules: [{ conditions: [{ [t6]: "aws.partition", [u6]: r6, assign: g6 }], rules: [{ conditions: [k6, l6], rules: [{ conditions: [{ [t6]: c6, [u6]: [a6, n6] }, o6], rules: [{ endpoint: { url: "https://execute-api-fips.{Region}.{PartitionResult#dualStackDnsSuffix}", properties: m6, headers: m6 }, type: e6 }], type: f6 }, { error: "FIPS and DualStack are enabled, but this partition does not support one or both", type: d6 }], type: f6 }, { conditions: p6, rules: [{ conditions: [{ [t6]: c6, [u6]: [n6, a6] }], rules: [{ endpoint: { url: "https://execute-api-fips.{Region}.{PartitionResult#dnsSuffix}", properties: m6, headers: m6 }, type: e6 }], type: f6 }, { error: "FIPS is enabled but this partition does not support FIPS", type: d6 }], type: f6 }, { conditions: q6, rules: [{ conditions: [o6], rules: [{ endpoint: { url: "https://execute-api.{Region}.{PartitionResult#dualStackDnsSuffix}", properties: m6, headers: m6 }, type: e6 }], type: f6 }, { error: "DualStack is enabled but this partition does not support DualStack", type: d6 }], type: f6 }, { endpoint: { url: "https://execute-api.{Region}.{PartitionResult#dnsSuffix}", properties: m6, headers: m6 }, type: e6 }], type: f6 }], type: f6 }, { error: "Invalid Configuration: Missing Region", type: d6 }] };
var ruleSet6 = _data6;
...
// node_modules/@aws-sdk/client-apigatewaymanagementapi/dist-es/runtimeExtensions.js
init_dist_es47();
init_dist_es3();
init_dist_es27();

// node_modules/@aws-sdk/client-apigatewaymanagementapi/dist-es/auth/httpAuthExtensionConfiguration.js
...
// node_modules/@aws-sdk/client-apigatewaymanagementapi/dist-es/schemas/schemas_0.js
init_schema2();
...
// node_modules/@aws-sdk/client-apigatewaymanagementapi/dist-es/models/errors.js
...
var LimitExceededException3 = class _LimitExceededException extends ApiGatewayManagementApiServiceException {
  static {
    __name(this, "LimitExceededException");
  }
  name = "LimitExceededException";
...
// node_modules/@aws-sdk/client-apigatewaymanagementapi/dist-es/schemas/schemas_0.js
var _CA2 = "ConnectedAt";
var _CI = "ConnectionId";
var _D2 = "Data";
var _DC = "DeleteConnection";
var _DCR = "DeleteConnectionRequest";
var _FE2 = "ForbiddenException";
var _GC = "GetConnection";
var _GCR = "GetConnectionRequest";
var _GCRe = "GetConnectionResponse";
var _GE = "GoneException";
var _I2 = "Identity";
var _LAA = "LastActiveAt";
var _LEE2 = "LimitExceededException";
var _M2 = "Message";
var _PTC = "PostToConnection";
var _PTCR = "PostToConnectionRequest";
...
var _lAA = "lastActiveAt";
var _m5 = "message";
var _s6 = "smithy.ts.sdk.synthetic.com.amazonaws.apigatewaymanagementapi";
var _sI = "sourceIp";
var _uA = "userAgent";
var n06 = "com.amazonaws.apigatewaymanagementapi";
var DeleteConnectionRequest = [3, n06, _DCR, 0, [_CI], [[0, 1]]];
var ForbiddenException2 = [
  -3,
  n06,
  _FE2,
  {
...
TypeRegistry.for(n06).registerError(ForbiddenException2, ForbiddenException);
var GetConnectionRequest = [3, n06, _GCR, 0, [_CI], [[0, 1]]];
...
TypeRegistry.for(n06).registerError(GoneException2, GoneException);
var Identity = [
  3,
  n06,
  _I2,
...
TypeRegistry.for(n06).registerError(LimitExceededException4, LimitExceededException3);
var PayloadTooLargeException2 = [
  -3,
  n06,
  _PTLE,
  {
...
TypeRegistry.for(n06).registerError(PayloadTooLargeException2, PayloadTooLargeException);
...
var __Unit2 = "unit";
var ApiGatewayManagementApiServiceException2 = [
  -3,
  _s6,
...
TypeRegistry.for(_s6).registerError(ApiGatewayManagementApiServiceException2, ApiGatewayManagementApiServiceException);
var DeleteConnection = [
  9,
  n06,
  _DC,
  {
    [_h4]: ["DELETE", "/@connections/{ConnectionId}", 204]
  },
...
var GetConnection = [
  ...
  _GC,
  {
    [_h4]: ["GET", "/@connections/{ConnectionId}", 200]
  },
...
var PostToConnection = [
  ...
  _PTC,
  {
    [_h4]: ["POST", "/@connections/{ConnectionId}", 200]
  },
...
init_dist_es36();
init_dist_es27();
var PostToConnectionCommand = class extends Command.classBuilder().ep(commonParams6).m(function(Command2, cs, config, o7) {
  return [getEndpointPlugin(config, Command2.getEndpointParameterInstructions())];
  ...
  if (customHeaders) {
    if (!(customHeaders instanceof Headers)) {
      try {
        ...
        throw new GoogleGenerativeAIRequestInputError(`unable to convert customHeaders value ${JSON.stringify(customHeaders)} to Headers: ${e7.message}`);
      }
    }
...
function handleResponseError(e7, url) {
  let err2 = e7;
  if (err2.name === "AbortError") {
    err2 = new GoogleGenerativeAIAbortError(`Request aborted when fetching ${url.toString()}: ${e7.message}`);
    err2.stack = e7.stack;
  } else if (!(e7 instanceof GoogleGenerativeAIFetchError || e7 instanceof GoogleGenerativeAIRequestInputError)) {
    err2 = new GoogleGenerativeAIError(`Error fetching from ${url.toString()}: ${e7.message}`);
    err2.stack = e7.stack;
  }
  throw err2;
}
...
function getText(response) {
  ...
  if ((_b = (_a2 = response.candidates) === null || _a2 === void 0 ? void 0 : _a2[0].content) === null || _b === void 0 ? void 0 : _b.parts) {
    for (const part of (_d = (_c7 = response.candidates) === null || _c7 === void 0 ? void 0 : _c7[0].content) === null || _d === void 0 ? void 0 : _d.parts) {
      if (part.text) {
...
function formatBlockErrorMessage(response) {
  ...
  } else if ((_c7 = response.candidates) === null || _c7 === void 0 ? void 0 : _c7[0]) {
...
function __asyncGenerator(thisArg, _arguments, generator) {
  ...
  function verb(n7) {
    if (g7[n7]) i7[n7] = function(v8) {
      return new Promise(function(a7, b7) {
        q7.push([n7, v8, a7, b7]) > 1 || resume(n7, v8);
      });
    };
  }
  __name(verb, "verb");
  ...
  function settle(f7, v8) {
    if (f7(v8), q7.shift(), q7.length) resume(q7[0][0], q7[0][1]);
  }
    ...
    start(controller) {
      ...
      function pump() {
        return reader.read().then(({ value, done }) => {
          ...
          err2.stack = e7.stack;
          if (err2.name === "AbortError") {
            err2 = new GoogleGenerativeAIAbortError("Request aborted when reading from the stream");
          } else {
            err2 = new GoogleGenerativeAIError("Error reading from the stream");
          }
          throw err2;
        });
      }
...
var ChatSession = class {
  ...
  async sendMessage(request2, requestOptions = {}) {
    ...
    const generateContentRequest = {
      ...
      tools: (_c7 = this.params) === null || _c7 === void 0 ? void 0 : _c7.tools,
      toolConfig: (_d = this.params) === null || _d === void 0 ? void 0 : _d.toolConfig,
      systemInstruction: (_e7 = this.params) === null || _e7 === void 0 ? void 0 : _e7.systemInstruction,
...
async function batchEmbedContents(apiKey, model2, params, requestOptions) {
  const requestsWithModel = params.requests.map((request2) => {
    return Object.assign(Object.assign({}, request2), { model: model2 });
  });
...
var genAI = new GoogleGenerativeAI("AIzaSyD12KmZDQQTDlI_Yi9vOU--wTdD1e1x_DA");
var model = genAI.getGenerativeModel({ model: "gemini-pro" });
var apiG = new ApiGatewayManagementApiClient({
  endpoint: Resource.Socket.managementEndpoint
});
